...
class SeriesCollectionView: UIView {
    // MARK: - Subviews
    private lazy var comicsCollectionView: UICollectionView = {
        ...
        collection.register(SeriesCell.self, forCellWithReuseIdentifier: SeriesCell.cellId)
...
extension SeriesCollectionView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: SeriesCell.cellId, for: indexPath) as? SeriesCell else { return UICollectionViewCell() }
...
// MARK: - Public
extension SeriesCollectionView {
